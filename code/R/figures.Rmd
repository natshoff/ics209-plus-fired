...
# join the attributes
state.summary <- inner_join(states%>%as_tibble(), state.summary, by="STUSPS") %>%
  st_as_sf()
...
# join the attributes
gacc.summary <- inner_join(gaccs%>%as_tibble(), gacc.summary, by="GACCAbbrev") %>%
  st_as_sf()
...
# join the attributes
eco.summary <- inner_join(ecol3%>%as_tibble(), eco.summary, by="NA_L3CODE") %>%
  st_as_sf()
